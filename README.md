...
- [LVGL binding for Micropython](#lvgl-binding-for-micropython)
  - [ESP32-P4 firmware](#esp32-p4-firmware)
    - [Build requirements](#build-requirements)
    - [Generic ESP32-P4 build](#generic-esp32-p4-build)
    - [Waveshare ESP32-P4-WIFI6-Touch-LCD-4.3](#waveshare-esp32-p4-wifi6-touch-lcd-43)
    - [Flash](#flash)
  ...
  - [*Build Instructions*](#build-instructions)
    ...
    - [*Command line syntax/parameters*](#command-line-syntaxparameters)
      ...
      - [*Target Options (optional)*](#target-options-optional)
        ...
        - [*Model/Variant specific options*](#modelvariant-specific-options)
